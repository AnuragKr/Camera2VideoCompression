...
public class Camera2VideoFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        Log.i(Prefs.TAG, getString(R.string.app_name) + " version: " + GeneralUtils.getVersionName(getActivity()) );
        workFolder = getActivity().getFilesDir().getAbsolutePath() + "/";
        ...
        switch (view.getId()) {
            case R.id.video: {
                if (mIsRecordingVideo) {
                    stopRecordingVideo();
                    /**try{
                        new TranscdingBackground(getActivity()).execute();}
                    catch(Throwable th){
                        th.printStackTrace();
                    }**/
     ...
     public class TranscdingBackground extends AsyncTask<String, Integer, Integer>
    {
        ...
        protected Integer doInBackground(String... paths) {
           ...
           boolean isDeleted = GeneralUtils.deleteFileUtil(workFolder + "/vk.log");
            ...
            //Path where recorded video saved
            ...
            String commandStr1 = "ffmpeg -y -i" + " /" + part1 + "/" + part2 + "/" + part3 + "/" + part4 + "/" + part5 + "/" +
                    part6 + "/" + part7 + "/" + part8 + " -strict experimental -s 480x480 -r 30 -aspect 3:4 -ab 48000 -ac 2 -ar 22050 -vcodec mpeg4 -b 2097152 /sdcard/videokit/out1.mp4";

            LoadJNI vk = new LoadJNI();
            try {
                //Toast.makeText(getApplicationContext(), "starting command1", Toast.LENGTH_LONG).show();
                Log.i(Prefs.TAG, "=======running first command=========");
                vk.run(GeneralUtils.utilConvertToComplex(commandStr1),workFolder, getActivity());
